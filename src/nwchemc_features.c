...
static const NWChemCFeatureEntry k_features[] = {
    ...
    {"enum.NWChemBasisLibraryRoot", "NWChemBasisLibraryRoot", "Named enum for classic vs BSE library root", NWCHEMC_FEATURE_SCHEMA_FIELD, -1, 1, 1},
    {"enum.NWChemBasisAngularKind", "NWChemBasisAngularKind", "Named enum for cartesian vs spherical AO shells", NWCHEMC_FEATURE_SCHEMA_FIELD, -1, 1, 1},
    {"enum.NWChemBasisSegmentMode", "NWChemBasisSegmentMode", "Named enum for segment vs nosegment library loads", NWCHEMC_FEATURE_SCHEMA_FIELD, -1, 1, 1},
    ...
    {"field.NWChemInputStanza.mp2", "NWChemInputStanza.mp2", "NWChemInputStanza.mp2 Cap'n Proto field", NWCHEMC_FEATURE_SCHEMA_FIELD, 19, 1, 1},
    {"field.NWChemInputStanza.tddft", "NWChemInputStanza.tddft", "NWChemInputStanza.tddft Cap'n Proto field", NWCHEMC_FEATURE_SCHEMA_FIELD, 20, 1, 1},
