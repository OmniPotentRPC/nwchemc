...
static void test_render_parity_batch_stanzas(void **state) {
  ...
  assert_render_contains(blocks, "gw\n");
  assert_render_contains(blocks, "evgw0 6");
  assert_render_contains(blocks, "method cdgw 32");
  assert_render_contains(blocks, "solver newton 10");
  assert_render_contains(blocks, "convergence 0.003 ev");
  assert_render_contains(blocks, "states alpha occ 4 vir 4");
  assert_render_contains(blocks, "first 2");
  assert_render_contains(blocks, "eta 0.001");
  assert_render_contains(blocks, "rpa");
  assert_render_contains(blocks, "core");
  assert_render_contains(blocks, "et\n");
  assert_render_contains(blocks, "vectors react.movecs prod.movecs");
  assert_render_contains(blocks, "tol2e 1e-10");
  assert_render_contains(blocks, "fock");
  assert_render_contains(blocks, "fmo");
  assert_render_contains(blocks, "rism\n");
  assert_render_contains(blocks, "permittivity 78.4");
  assert_render_contains(blocks, "tau 1");
  assert_render_contains(blocks, "temp 298.15");
  assert_render_contains(blocks, "diis 5");
  assert_render_contains(blocks, "ngrid 4096");
  assert_render_contains(blocks, "closure kh");
  assert_render_contains(blocks, "vdw rule arithmetic parameters vdw.par");
  assert_render_contains(blocks, "dimqm\n");
  assert_render_contains(blocks, "frequency");
  assert_render_contains(blocks, "algorithm 1");
  assert_render_contains(blocks, "tolerance 1e-07");
  assert_render_contains(blocks, "efield 0 0 0.001");
