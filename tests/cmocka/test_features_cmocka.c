...
static void test_class_partition_counts(void **state) {
  ...
  assert_int_equal((int)stanzas, 41);
  assert_int_equal((int)fields, 14);
  assert_int_equal((int)schema_fields, 828);
  assert_int_equal((int)schema_methods, 12);
  assert_int_equal((int)abis, 121);
...
static void test_abi_entrypoints_interned(void **state) {
  ...
  static const char *ids[] = {
      ...
      "abi.nwchemc_session_configure",
      "abi.nwchemc_session_reset_topology",
      ...
      "abi.nwchemc_session_calculate_energy_result",
      "abi.nwchemc_calculate_energy_result",
      "abi.nwchemc_calculate_energy_result_from_config",
      ...
      "abi.nwchemc_calculate_hessian_result_from_config",
      "abi.nwchemc_calculate_dipole",
      "abi.nwchemc_calculate_dipole_from_config",
      ...
      "abi.nwchemc_calculate_quadrupole_result_from_config",
      "abi.nwchemc_calculate_optimize",
      "abi.nwchemc_calculate_optimize_from_config",
      ...
      "abi.nwchemc_calculate_optimize_result_from_config",
      "abi.nwchemc_calculate_frequencies",
      "abi.nwchemc_calculate_frequencies_detail",
      "abi.nwchemc_calculate_frequencies_from_config",
      "abi.nwchemc_calculate_frequencies_detail_from_config",
      ...
      "abi.nwchemc_calculate_frequencies_result_from_config",
      "abi.nwchemc_calculate_stress",
      "abi.nwchemc_calculate_stress_from_config",
      ...
      "abi.nwchemc_calculate_stress_result_from_config",
      ...
      "abi.nwchemc_session_calculate_frequencies_detail",
      "abi.nwchemc_session_calculate_stress",
      "abi.nwchemc_session_hessian",
      "abi.nwchemc_available",
      "abi.nwchemc_version",
      "abi.nwchemc_abi_version",
      "abi.nwchemc_last_error",
