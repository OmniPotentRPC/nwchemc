...
int main(int argc, char **argv) {
  ...
  g_mc_steps_default_params_path = argv[7];
  g_brillouin_tetrahedron_params_path = argv[8];
  g_brillouin_dos_grid_params_path = argv[9];
  g_nwpw_et_params_path = argv[10];
  g_nwpw_temperature_params_path = argv[11];
  g_nwpw_mapping_alias_params_path = argv[12];
  g_nwpw_virtual_alias_params_path = argv[13];
  g_nwpw_one_electron_guess_defaults_params_path = argv[14];
